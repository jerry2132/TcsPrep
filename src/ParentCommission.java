...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Parent has child members (y/n)");
        ...
        if(ans=='Y'||ans=='y')
        {
            System.out.print("Enter members separated by commas: ");
            ...
            int m =parts.length;
            double parentCommission = m*(0.1*5000);
            double membersCommission = 0.05*5000;
             System.out.println();
            System.out.println("total Members  : "+totalMembers);
           
            System.out.println("Commission Details");
            System.out.println(parent+" : "+parentCommission);
            
            for(int i=0;i<parts.length;i++)
            {
                System.out.println(parts[i]+"  :  "+membersCommission);
            }
        ...
        {
            System.out.println("total Members "+totalMembers);
            System.out.println("Parents Commission  "+(0.05*5000));
        }
        
        

        // Split the input into an array of strings using a comma as the delimiter
